 ...
 */
public class frHardware extends javax.swing.JFrame {

    /**
     * Creates new form frHardware
     */
    public frHardware() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        pnlPrincipal.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 650, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frHardware.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frHardware().setVisible(true);
            }
        });
    }
